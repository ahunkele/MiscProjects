...
public class MyGLRenderer implements GLSurfaceView.Renderer {
    ...
    public int totoalDX = -1;
    public int totalDY = -1;
    ...
    private void setupGL() {
        ...
        this.totoalDX = GLES20.glGetUniformLocation(this.myGLESProgram, "deltaX");
        this.totalDY = GLES20.glGetUniformLocation(this.myGLESProgram, "deltaY");
    ...
    private void draw() {
        ...
        GLES20.glUniform1f(this.totoalDX , 0.0f);
        GLES20.glUniform1f(this.totalDY , 0.0f);
        ...
        GLES20.glDrawArrays( GLES20.GL_LINES, 42, 84 );
        ...
        GLES20.glDrawArrays( GLES20.GL_LINES, 84, 126 );
    ...
    public void touchesMoved(float x, float y) {
        ...
        this.dX = (int)this.myTouchXcurrent - (int)this.myTouchXold;
        this.dY = (int)this.myTouchYcurrent - (int)this.myTouchYold;

        this.totoalDX += this.dX;
