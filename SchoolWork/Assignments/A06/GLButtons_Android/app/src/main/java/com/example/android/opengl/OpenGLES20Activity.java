...
public class OpenGLES20Activity extends Activity {
    ...
    public void onCreate(Bundle pSavedInstanceState) {
        ...
        Button rotateButton = getButton(R.drawable.bluebutton, "GreenSource", true, 0);
        toprow.addView(rotateButton);
        toprow.addView(getBuffer());

        Button txyButton = getButton(R.drawable.darkbluebutton, "RedSource", true, 1);
        toprow.addView(txyButton);
        toprow.addView(getBuffer());

        Button txzButton = getButton(R.drawable.darkbluebutton, "BlueSource", true, 2);
        toprow.addView(txzButton);
        toprow.addView(getBuffer());

        Button scaleButton = getButton(R.drawable.darkbluebutton, "Cast", true, 3);
        ...
        Button obj1Button = getButton(R.drawable.bluebutton, "RedMask", false, 0);
        bottomrow.addView(obj1Button);
        bottomrow.addView(getBuffer());

        Button obj2Button = getButton(R.drawable.darkbluebutton, "GreenMask", false, 1);
        bottomrow.addView(obj2Button);
        bottomrow.addView(getBuffer());

        Button obj3Button = getButton(R.drawable.darkbluebutton, "BlueMask", false, 2);
        bottomrow.addView(obj3Button);
        bottomrow.addView(getBuffer());

        Button camButton = getButton(R.drawable.darkbluebutton, "Filter", false, 3);
